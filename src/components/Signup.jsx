...
export default function Signup() {
  function signupAction(prevFormState, formData) {
    ...
    const lastName = formData.get("last-name"); // Corrected variable name from LastName to lastName
    ...
    // FIX: Changed 'email' to 'enteredEmail'
    ...
    // FIX: Changed 'LastName' to 'lastName'
    ...
    if (errors.length > 0) {
      // FIX: You need to return the errors object so it can be accessed by formState.errors
      return {
        errors ,
        enteredValues: {
          email:enteredEmail,
    ...
    // If no errors, you might want to return a success state or null for errors
    return { errors: null };
  }
